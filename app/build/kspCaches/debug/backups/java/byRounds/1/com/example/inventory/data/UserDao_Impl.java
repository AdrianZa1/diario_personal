...
public final class UserDao_Impl implements UserDao {
  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR IGNORE INTO `users` (`id`,`username`,`email`,`password`) VALUES (nullif(?, 0),?,?,?)";
      }
    ...
    this.__updateAdapterOfUser = new EntityDeletionOrUpdateAdapter<User>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `users` SET `id` = ?,`username` = ?,`email` = ?,`password` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Flow<List<User>> getAllItems() {
      ...
      public List<User> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new User(_tmpId,_tmpUsername,_tmpEmail,_tmpPassword);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<User> getItem(final int id) {
